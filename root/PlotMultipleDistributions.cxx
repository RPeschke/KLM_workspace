void PlotMultipleDistributions(const char* root_file, const char* plotTitle, const float actHV, const int chNo) {
  ...
  TH1F* hist0 = new TH1F("hist0", "Peak Value Distribution", 300,0,600);
  ...
  TH1F* hist2 = new TH1F("hist2", "Partial Riemann Sum", 300,-1000,7000);
