...
ROOT.gROOT.LoadMacro("rootMacros/PlotIntegratedPulseDist.cxx")
...
testCh = 0
for DACoffset in range(19,20,1):
    ctrl.open()
    testHV = 194#hvBest[testCh] + DACoffset
    actHV = 74.43-5*(testHV/256.)
    print "HV: %.3F" % float(actHV)
    #------------------------------------------------------------------------------#
    ...
    ROOT.MakePedSubtractedTTree(waveformOutfile, pedfile, "ASIC4_ch0_hv_194_70p65v_th167.root")#root_filename)
#    ROOT.MakePedSubtractedTTree(waveformOutfile, pedfile, root_filename)
    print "Data written in: ASIC4_ch0_hv_194_70p65v_th167.root"
#    print "Data written in:  %s\n" % root_filename
...
#    os.system("chown -R testbench2:testbench2 " + root_filename)
    ...
    ROOT.PlotSomeWaveforms("ASIC4_ch0_hv_194_70p65v_th167.root")
    ...
    ROOT.PlotIntegratedPulseDist("ASIC4_ch0_hv_194_70p65v_th167.root","RiemannSumPulseDist_ASIC4_ch0_hv_194_70p65v_th167")
