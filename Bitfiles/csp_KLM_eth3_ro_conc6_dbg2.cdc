...
Project.filter<2>=internal_w*
Project.filter<3>=internal_w
Project.filter<4>=internal_wr*
Project.filter<5>=
...
Project.unit<2>.dataPortWidth=120
...
Project.unit<2>.triggerChannel<1><20>=klm_scrod_trig_interface trigasic_bram_rd_data<3>
Project.unit<2>.triggerChannel<1><21>=klm_scrod_trig_interface trigasic_bram_rd_data<2>
Project.unit<2>.triggerChannel<1><22>=klm_scrod_trig_interface trigasic_bram_rd_data<1>
Project.unit<2>.triggerChannel<1><23>=klm_scrod_trig_interface trigasic_bram_rd_data<0>
Project.unit<2>.triggerChannel<1><24>=klm_scrod_trig_interface exttb<3><5>
Project.unit<2>.triggerChannel<1><25>=klm_scrod_trig_interface exttb<3><4>
Project.unit<2>.triggerChannel<1><26>=klm_scrod_trig_interface exttb<3><3>
Project.unit<2>.triggerChannel<1><27>=klm_scrod_trig_interface exttb<3><2>
Project.unit<2>.triggerChannel<1><28>=klm_scrod_trig_interface exttb<3><1>
Project.unit<2>.triggerChannel<1><29>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_we
Project.unit<2>.triggerChannel<1><2>=klm_scrod_trig_interface trigasic_select<7>
Project.unit<2>.triggerChannel<1><30>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_we_i_0
Project.unit<2>.triggerChannel<1><31>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<10>
Project.unit<2>.triggerChannel<1><32>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<9>
Project.unit<2>.triggerChannel<1><33>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<8>
Project.unit<2>.triggerChannel<1><34>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<7>
Project.unit<2>.triggerChannel<1><35>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<6>
Project.unit<2>.triggerChannel<1><36>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<5>
Project.unit<2>.triggerChannel<1><37>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<4>
Project.unit<2>.triggerChannel<1><38>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<3>
Project.unit<2>.triggerChannel<1><39>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<2>
Project.unit<2>.triggerChannel<1><3>=klm_scrod_trig_interface trigasic_select<6>
Project.unit<2>.triggerChannel<1><40>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<1>
Project.unit<2>.triggerChannel<1><41>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_addr<0>
Project.unit<2>.triggerChannel<1><42>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_data
Project.unit<2>.triggerChannel<1><43>=klm_scrod_trig_interface conc_intfc_ins trigasic_bram_wr_data<0>
Project.unit<2>.triggerChannel<1><44>=internal_SMP_MAIN_CNT<8>
Project.unit<2>.triggerChannel<1><45>=internal_SMP_MAIN_CNT<7>
Project.unit<2>.triggerChannel<1><46>=internal_SMP_MAIN_CNT<6>
Project.unit<2>.triggerChannel<1><47>=internal_SMP_MAIN_CNT<5>
Project.unit<2>.triggerChannel<1><48>=internal_SMP_MAIN_CNT<4>
Project.unit<2>.triggerChannel<1><49>=internal_SMP_MAIN_CNT<3>
Project.unit<2>.triggerChannel<1><4>=klm_scrod_trig_interface trigasic_select<5>
Project.unit<2>.triggerChannel<1><50>=internal_SMP_MAIN_CNT<2>
Project.unit<2>.triggerChannel<1><51>=internal_SMP_MAIN_CNT<1>
Project.unit<2>.triggerChannel<1><52>=internal_SSTIN
Project.unit<2>.triggerChannel<1><53>=internal_READCTRL_trigger
Project.unit<2>.triggerChannel<1><54>=u_SamplingLgc wr_addrclr
Project.unit<2>.triggerChannel<1><55>=
...
Project.unit<2>.triggerPortWidth<1>=55
